...
@Module({
  imports: [BookingJobModule,EmailModule,notificationModel],
  controllers: [BookingController],
  providers: [BookingRepository, ConfirmBookingHandler, ConfirmBookingEvent, SearchAvailabilityHandler, SelectRoomsHandler,
    NotificationRepository,HotelRepository
  ],
})
